...
public record Advancement(
	...
	private static Advancement read(RegistryFriendlyByteBuf registryFriendlyByteBuf) {
		return new Advancement(
			registryFriendlyByteBuf.readOptional(FriendlyByteBuf::readIdentifier),
	...
	public static class Builder {
		...
		public Advancement.Builder parent(Identifier identifier) {
		...
		public Advancement.Builder display(
			...
			return this.display(
				new DisplayInfo(itemStack, component, component2, Optional.ofNullable(identifier).map(ClientAsset.ResourceTexture::new), advancementType, bl, bl2, bl3)
			);
		}
		...
		public Advancement.Builder display(
			...
			return this.display(
				new DisplayInfo(
					...
					component,
					component2,
					Optional.ofNullable(identifier).map(ClientAsset.ResourceTexture::new),
					advancementType,
					bl,
					bl2,
					bl3
		...
		public AdvancementHolder build(Identifier identifier) {
			...
			return new AdvancementHolder(identifier, new Advancement(this.parent, this.display, this.rewards, map, advancementRequirements, this.sendsTelemetryEvent));
		}
