...
public class JfrResultJsonSerializer {
	...
	private JsonElement structureGen(List<StructureGenStat> list) {
		...
		if (optional.isEmpty()) {
			...
			TimedStatSummary<StructureGenStat> timedStatSummary = (TimedStatSummary<StructureGenStat>)optional.get();
				...
				.forEach(
					(string, listx) -> {
						...
						if (!optionalx.isEmpty()) {
							TimedStatSummary<StructureGenStat> timedStatSummary2 = (TimedStatSummary<StructureGenStat>)optionalx.get();
