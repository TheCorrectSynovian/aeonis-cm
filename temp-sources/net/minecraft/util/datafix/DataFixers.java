...
public class DataFixers {
	...
	private static void addFixers(DataFixerBuilder dataFixerBuilder) {
		...
		dataFixerBuilder.addFixer(
			ItemRenameFix.create(schema131, "Renamed grass path item to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path"))
		);
		dataFixerBuilder.addFixer(
			BlockRenameFix.create(schema131, "Renamed grass path block to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path"))
		);
		...
		ImmutableMap<String, String> immutableMap = ImmutableMap.<String, String>builder()
			...
			.build();
		dataFixerBuilder.addFixer(ItemRenameFix.create(schema135, "Renamed copper block items to new oxidized terms", createRenamer(immutableMap)));
		dataFixerBuilder.addFixer(BlockRenameFix.create(schema135, "Renamed copper blocks to new oxidized terms", createRenamer(immutableMap)));
		...
		ImmutableMap<String, String> immutableMap2 = ImmutableMap.<String, String>builder()
			...
			.build();
		dataFixerBuilder.addFixer(ItemRenameFix.create(schema136, "Rename copper item suffixes", createRenamer(immutableMap2)));
		dataFixerBuilder.addFixer(BlockRenameFix.create(schema136, "Rename copper blocks suffixes", createRenamer(immutableMap2)));
		...
		ImmutableMap<String, String> immutableMap3 = ImmutableMap.<String, String>builder()
			...
			.build();
		dataFixerBuilder.addFixer(ItemRenameFix.create(schema138, "Renamed grimstone block items to deepslate", createRenamer(immutableMap3)));
		dataFixerBuilder.addFixer(BlockRenameFix.create(schema138, "Renamed grimstone blocks to deepslate", createRenamer(immutableMap3)));
		...
		dataFixerBuilder.addFixer(
			ItemRenameFix.create(
				schema145, "Rename azalea_leaves_flowers", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))
			)
		);
		dataFixerBuilder.addFixer(
			BlockRenameFix.create(
				schema145, "Rename azalea_leaves_flowers items", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))
			)
		);
		...
		dataFixerBuilder.addFixer(
			new NamespacedTypeRenameFix(schema150, "Caves and Cliffs biome renames", References.BIOME, createRenamer(CavesAndCliffsRenames.RENAMES))
		);
		...
		dataFixerBuilder.addFixer(
			new NamespacedTypeRenameFix(schema153, "Remove Deep Warm Ocean", References.BIOME, createRenamer("minecraft:deep_warm_ocean", "minecraft:warm_ocean"))
		);
		...
		dataFixerBuilder.addFixer(
			new EntityFieldsRenameFix(schema167, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing"))
		);
		...
		dataFixerBuilder.addFixer(
			new PoiTypeRemoveFix(schema170, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains)
		);
		...
		dataFixerBuilder.addFixer(
			BlockEntityRenameFix.create(schema184, "Rename Suspicious Sand to Brushable Block", createRenamer("minecraft:suspicious_sand", "minecraft:brushable_block"))
		);
		...
		dataFixerBuilder.addFixer(
			new RenameEnchantmentsFix(schema205, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge"))
		);
		...
		dataFixerBuilder.addFixer(
			new AttributesRenameLegacy(schema214, "Rename jump strength attribute", createRenamer("minecraft:horse.jump_strength", "minecraft:generic.jump_strength"))
		);
		...
		dataFixerBuilder.addFixer(
			new EntityAttributeBaseValueFix(schema247, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", d -> d == 48.0 ? 16.0 : d)
		);
		dataFixerBuilder.addFixer(
			new EntityAttributeBaseValueFix(schema247, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", d -> d == 48.0 ? 16.0 : d)
		);
		dataFixerBuilder.addFixer(
			new EntityAttributeBaseValueFix(schema247, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", d -> d == 48.0 ? 16.0 : d)
		);
		dataFixerBuilder.addFixer(
			new EntityAttributeBaseValueFix(schema247, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", d -> d == 40.0 ? 16.0 : d)
		);
		dataFixerBuilder.addFixer(
			new EntityAttributeBaseValueFix(schema247, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", d -> d == 16.0 ? 12.0 : d)
		);
		dataFixerBuilder.addFixer(
			new EntityAttributeBaseValueFix(schema247, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", d -> d == 16.0 ? 24.0 : d)
		);
		...
		dataFixerBuilder.addFixer(
			new BlockPropertyRenameAndFix(schema261, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", string -> string)
		);
		...
		dataFixerBuilder.addFixer(
			new AdvancementsRenameFix(
				schema265, false, "Use lodestone category change", createRenamer("minecraft:nether/use_lodestone", "minecraft:adventure/use_lodestone")
			)
		);
		...
		dataFixerBuilder.addFixer(BlockRenameFix.create(schema276, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
		dataFixerBuilder.addFixer(ItemRenameFix.create(schema276, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
