							...
							map2x -> map2x.forEach(
								(dynamic2x, dynamic3) -> {
									...
									if ("stronghold".equals(string)) {
										...
										switch (string2) {
											case "distance":
												mutableInt.setValue(getInt(string3, mutableInt.intValue(), 1));
												return;
											case "spread":
												mutableInt2.setValue(getInt(string3, mutableInt2.intValue(), 1));
												return;
											case "count":
												mutableInt3.setValue(getInt(string3, mutableInt3.intValue(), 1));
												return;
										}
									} else {
										switch (string2) {
			...
			builder.put(
				...
				optionalDynamic.createMap(
					ImmutableMap.of(
						...
						optionalDynamic.createInt(mutableInt.intValue()),
						optionalDynamic.createString("spread"),
						optionalDynamic.createInt(mutableInt2.intValue()),
						optionalDynamic.createString("count"),
						optionalDynamic.createInt(mutableInt3.intValue())
					)
				)
			);
		}
