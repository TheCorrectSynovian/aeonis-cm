...
public class Connection extends SimpleChannelInboundHandler<Packet<?>> {
	...
	public static Connection connectToServer(
		InetSocketAddress inetSocketAddress, EventLoopGroupHolder eventLoopGroupHolder, @Nullable LocalSampleLogger localSampleLogger
	) {
		...
		ChannelFuture channelFuture = connect(inetSocketAddress, eventLoopGroupHolder, connection);
		channelFuture.syncUninterruptibly();
		return connection;
	}

	public static ChannelFuture connect(InetSocketAddress inetSocketAddress, EventLoopGroupHolder eventLoopGroupHolder, Connection connection) {
