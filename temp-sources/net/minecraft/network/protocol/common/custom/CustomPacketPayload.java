...
public interface CustomPacketPayload {
	...
	static <B extends FriendlyByteBuf> StreamCodec<B, CustomPacketPayload> codec(
		...
		final Map<Identifier, StreamCodec<? super B, ? extends CustomPacketPayload>> map = (Map<Identifier, StreamCodec<? super B, ? extends CustomPacketPayload>>)list.stream()
		...
		return new StreamCodec<B, CustomPacketPayload>() {
			private StreamCodec<? super B, ? extends CustomPacketPayload> findCodec(Identifier identifier) {
				StreamCodec<? super B, ? extends CustomPacketPayload> streamCodec = (StreamCodec<? super B, ? extends CustomPacketPayload>)map.get(identifier);
