...
public abstract class CompositeSlotSource implements SlotSource {
	...
	public SlotCollection provide(LootContext lootContext) {
		return (SlotCollection)this.compositeSlotSource.apply(lootContext);
	}
	...
	public void validate(ValidationContext validationContext) {
		...
		for (int i = 0; i < this.terms.size(); i++) {
			((SlotSource)this.terms.get(i)).validate(validationContext.forChild(new ProblemReporter.IndexedFieldPathElement("terms", i)));
		}
	}
}
