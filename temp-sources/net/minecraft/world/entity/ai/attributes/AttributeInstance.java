...
public class AttributeInstance {
	...
	Map<Identifier, AttributeModifier> getModifiers(AttributeModifier.Operation operation) {
		return (Map<Identifier, AttributeModifier>)this.modifiersByOperation.computeIfAbsent(operation, operationx -> new Object2ObjectOpenHashMap());
	}
	...
	@Nullable
	public AttributeModifier getModifier(Identifier identifier) {
		return (AttributeModifier)this.modifierById.get(identifier);
	}
	...
	public boolean removeModifier(Identifier identifier) {
		AttributeModifier attributeModifier = (AttributeModifier)this.modifierById.remove(identifier);
