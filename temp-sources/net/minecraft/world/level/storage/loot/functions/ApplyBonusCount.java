...
public class ApplyBonusCount extends LootItemConditionalFunction {
	...
	private static final Codec<ApplyBonusCount.FormulaType> FORMULA_TYPE_CODEC = Identifier.CODEC.comapFlatMap(identifier -> {
		ApplyBonusCount.FormulaType formulaType = (ApplyBonusCount.FormulaType)FORMULAS.get(identifier);
	...
	public static LootItemConditionalFunction.Builder<?> addOreBonusCount(Holder<Enchantment> holder) {
		return simpleBuilder(list -> new ApplyBonusCount(list, holder, ApplyBonusCount.OreDrops.INSTANCE));
	}
