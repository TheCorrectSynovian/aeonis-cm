...
public class SetAttributesFunction extends LootItemConditionalFunction {
	...
	public static SetAttributesFunction.ModifierBuilder modifier(
		Identifier identifier, Holder<Attribute> holder, AttributeModifier.Operation operation, NumberProvider numberProvider
	) {
		return new SetAttributesFunction.ModifierBuilder(identifier, holder, operation, numberProvider);
	}
