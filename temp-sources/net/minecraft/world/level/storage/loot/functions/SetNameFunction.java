...
public class SetNameFunction extends LootItemConditionalFunction {
	...
	public Set<ContextKey<?>> getReferencedContextParams() {
		return (Set<ContextKey<?>>)this.resolutionContext.map(entityTarget -> Set.of(entityTarget.contextParam())).orElse(Set.of());
	}
	...
	public static UnaryOperator<Component> createResolver(LootContext lootContext, @Nullable LootContext.EntityTarget entityTarget) {
		if (entityTarget != null) {
			Entity entity = lootContext.getOptionalParameter(entityTarget.contextParam());
			if (entity != null) {
