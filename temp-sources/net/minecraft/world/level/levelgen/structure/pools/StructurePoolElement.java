...
public abstract class StructurePoolElement {
	...
	public static Function<StructureTemplatePool.Projection, LegacySinglePoolElement> legacy(String string) {
		return projection -> new LegacySinglePoolElement(Either.left(Identifier.parse(string)), EMPTY, projection, Optional.empty());
	}
	...
	public static Function<StructureTemplatePool.Projection, LegacySinglePoolElement> legacy(String string, Holder<StructureProcessorList> holder) {
		return projection -> new LegacySinglePoolElement(Either.left(Identifier.parse(string)), holder, projection, Optional.empty());
	}

	public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(String string) {
		return projection -> new SinglePoolElement(Either.left(Identifier.parse(string)), EMPTY, projection, Optional.empty());
	}
	...
	public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(String string, Holder<StructureProcessorList> holder) {
		return projection -> new SinglePoolElement(Either.left(Identifier.parse(string)), holder, projection, Optional.empty());
	}
	...
	public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(String string, LiquidSettings liquidSettings) {
		return projection -> new SinglePoolElement(Either.left(Identifier.parse(string)), EMPTY, projection, Optional.of(liquidSettings));
	}
	...
	public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(
		...
		return projection -> new SinglePoolElement(Either.left(Identifier.parse(string)), holder, projection, Optional.of(liquidSettings));
	}
