...
public class ShipwreckPieces {
	...
	public static ShipwreckPieces.ShipwreckPiece addRandomPiece(
		...
		ShipwreckPieces.ShipwreckPiece shipwreckPiece = new ShipwreckPieces.ShipwreckPiece(structureTemplateManager, identifier, blockPos, rotation, bl);
	...
	public static class ShipwreckPiece extends TemplateStructurePiece {
		...
		public ShipwreckPiece(StructureTemplateManager structureTemplateManager, Identifier identifier, BlockPos blockPos, Rotation rotation, boolean bl) {
			super(StructurePieceType.SHIPWRECK_PIECE, 0, structureTemplateManager, identifier, identifier.toString(), makeSettings(rotation), blockPos);
			this.isBeached = bl;
		}
		...
		public ShipwreckPiece(StructureTemplateManager structureTemplateManager, CompoundTag compoundTag) {
			super(
				...
				identifier -> makeSettings((Rotation)compoundTag.read("Rot", Rotation.LEGACY_CODEC).orElseThrow())
			);
