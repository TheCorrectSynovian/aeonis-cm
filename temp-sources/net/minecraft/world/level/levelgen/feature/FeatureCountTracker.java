			...
			.forEach(
				(serverLevel, levelData) -> {
					...
					levelData.featureData()
						.forEach(
							(ObjectIntBiConsumer<? super FeatureCountTracker.FeatureData>)((featureData, j) -> LOGGER.debug(
								"{} {} {} {} {} {}",
								string2,
								String.format(Locale.ROOT, "%10d", j),
								String.format(Locale.ROOT, "%10f", (double)j / i),
