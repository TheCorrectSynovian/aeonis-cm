...
public class JigsawBlockEntity extends BlockEntity {
	...
	protected void loadAdditional(ValueInput valueInput) {
		...
		this.name = (Identifier)valueInput.read("name", Identifier.CODEC).orElse(EMPTY_ID);
		this.target = (Identifier)valueInput.read("target", Identifier.CODEC).orElse(EMPTY_ID);
