...
public final class OverworldBiomeBuilder {
	...
	private void addDebugBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer) {
		...
		if (TerrainProvider.buildErosionOffsetSpline(coordinate2, coordinate3, -0.15F, 0.0F, 0.0F, 0.1F, 0.0F, -0.03F, false, false, BoundedFloatFunction.IDENTITY) instanceof CubicSpline.Multipoint<?, ?> multipoint
			)
		 {
