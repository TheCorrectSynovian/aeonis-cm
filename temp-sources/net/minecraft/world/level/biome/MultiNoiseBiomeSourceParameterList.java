...
public class MultiNoiseBiomeSourceParameterList {
	...
	public record Preset(Identifier id, MultiNoiseBiomeSourceParameterList.Preset.SourceProvider provider) {
		...
		static final Map<Identifier, MultiNoiseBiomeSourceParameterList.Preset> BY_NAME = (Map<Identifier, MultiNoiseBiomeSourceParameterList.Preset>)Stream.of(
				NETHER, OVERWORLD
			)
		...
		public static final Codec<MultiNoiseBiomeSourceParameterList.Preset> CODEC = Identifier.CODEC
			.flatXmap(
				identifier -> (DataResult)Optional.ofNullable((MultiNoiseBiomeSourceParameterList.Preset)BY_NAME.get(identifier))
