...
public class RealmsBackupInfoScreen extends RealmsScreen {
	...
	Component checkForSpecificMetadata(String string, String string2) {
		...
		} else if (string3.contains("game") && string3.contains("difficulty")) {
			return this.gameDifficultyMetadata(string2);
		} else {
			return (Component)(string.equals("world_type") ? this.parseWorldType(string2) : Component.literal(string2));
		}
	}
