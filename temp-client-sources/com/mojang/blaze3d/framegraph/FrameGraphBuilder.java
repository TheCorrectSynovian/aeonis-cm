...
public class FrameGraphBuilder {
	...
	<T> FrameGraphBuilder.InternalVirtualResource<T> createInternalResource(String string, ResourceDescriptor<T> resourceDescriptor, FrameGraphBuilder.Pass pass) {
	...
	static class ExternalResource<T> extends FrameGraphBuilder.VirtualResource<T> {
		...
		public ExternalResource(String string, FrameGraphBuilder.Pass pass, T object) {
			super(string, pass);
	...
	static class Handle<T> implements ResourceHandle<T> {
		...
		Handle(FrameGraphBuilder.VirtualResource<T> virtualResource, int i, FrameGraphBuilder.Pass pass) {
	...
	static class InternalVirtualResource<T> extends FrameGraphBuilder.VirtualResource<T> {
		...
		public InternalVirtualResource(int i, String string, FrameGraphBuilder.Pass pass, ResourceDescriptor<T> resourceDescriptor) {
			super(string, pass);
			this.id = i;
	...
	abstract static class VirtualResource<T> {
		...
		public VirtualResource(String string, FrameGraphBuilder.Pass pass) {
			this.name = string;
