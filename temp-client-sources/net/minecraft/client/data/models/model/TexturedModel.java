...
public class TexturedModel {
	...
	public interface Provider {
		...
		default Identifier create(Block block, BiConsumer<Identifier, ModelInstance> biConsumer) {
			return this.get(block).create(block, biConsumer);
		}

		default Identifier createWithSuffix(Block block, String string, BiConsumer<Identifier, ModelInstance> biConsumer) {
