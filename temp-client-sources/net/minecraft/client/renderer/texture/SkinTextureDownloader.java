...
public class SkinTextureDownloader {
	...
	public CompletableFuture<Texture> downloadAndRegisterSkin(Identifier identifier, Path path, String string, boolean bl) {
		DownloadedTexture downloadedTexture = new DownloadedTexture(identifier, string);
