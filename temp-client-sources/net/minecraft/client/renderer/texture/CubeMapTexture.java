...
public class CubeMapTexture extends ReloadableTexture {
	...
	public TextureContents loadContents(ResourceManager resourceManager) throws IOException {
		...
		TextureContents textureContents = TextureContents.load(resourceManager, identifier.withSuffix(SUFFIXES[0]));
		...
		try {
			...
			for (int k = 1; k < 6; k++) {
				TextureContents textureContents2 = TextureContents.load(resourceManager, identifier.withSuffix(SUFFIXES[k]));
			...
			var15 = new TextureContents(nativeImage, new TextureMetadataSection(true, false, MipmapStrategy.MEAN, 0.0F));
