...
public class MushroomCowRenderer extends AgeableMobRenderer<MushroomCow, MushroomCowRenderState, CowModel> {
	private static final Map<Variant, Identifier> TEXTURES = (Map<Variant, Identifier>)Util.make(Maps.newHashMap(), hashMap -> {
		hashMap.put(Variant.BROWN, Identifier.withDefaultNamespace("textures/entity/cow/brown_mooshroom.png"));
		hashMap.put(Variant.RED, Identifier.withDefaultNamespace("textures/entity/cow/red_mooshroom.png"));
	});
	...
	public Identifier getTextureLocation(MushroomCowRenderState mushroomCowRenderState) {
		return (Identifier)TEXTURES.get(mushroomCowRenderState.variant);
	}
