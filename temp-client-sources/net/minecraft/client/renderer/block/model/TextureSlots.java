...
public class TextureSlots {
	...
	public static TextureSlots.Data parseTextureMap(JsonObject jsonObject) {
	...
	private static void parseEntry(String string, String string2, TextureSlots.Data.Builder builder) {
