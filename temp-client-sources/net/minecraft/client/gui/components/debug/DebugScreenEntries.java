...
public class DebugScreenEntries {
	...
	private static Identifier register(String string, DebugScreenEntry debugScreenEntry) {
		return register(Identifier.withDefaultNamespace(string), debugScreenEntry);
	}
	...
	@Nullable
	public static DebugScreenEntry getEntry(Identifier identifier) {
		return (DebugScreenEntry)ENTRIES_BY_ID.get(identifier);
	}
