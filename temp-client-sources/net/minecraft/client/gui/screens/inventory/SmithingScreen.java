...
public class SmithingScreen extends ItemCombinerScreen<SmithingMenu> {
	...
	public void containerTick() {
		...
		this.baseIcon.tick((List<Identifier>)optional.map(SmithingTemplateItem::getBaseSlotEmptyIcons).orElse(List.of()));
		this.additionalIcon.tick((List<Identifier>)optional.map(SmithingTemplateItem::getAdditionalSlotEmptyIcons).orElse(List.of()));
	}
