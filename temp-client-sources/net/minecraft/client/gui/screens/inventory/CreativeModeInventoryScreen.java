...
public class CreativeModeInventoryScreen extends AbstractContainerScreen<CreativeModeInventoryScreen.ItemPickerMenu> implements FabricCreativeInventoryScreen {
	...
	protected void renderBg(GuiGraphics guiGraphics, float f, int i, int j) {
		...
		if (selectedTab.canScroll()) {
			...
			guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, identifier, k, l + (int)((m - l - 17) * this.scrollOffs), 12, 15);
		}
	...
	protected void renderTabButton(GuiGraphics guiGraphics, int i, int j, CreativeModeTab creativeModeTab) {
		...
		if (bl2) {
			...
			identifiers = bl ? SELECTED_BOTTOM_TABS : UNSELECTED_BOTTOM_TABS;
		}
