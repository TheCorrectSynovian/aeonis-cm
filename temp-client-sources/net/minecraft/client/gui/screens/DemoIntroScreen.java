...
public class DemoIntroScreen extends Screen {
	...
	protected void init() {
		...
		this.movementMessage = MultiLineLabel.create(
			...
			this.movementMessage(Component.translatable("demo.help.jump", new Object[]{options.keyJump.getTranslatedKeyMessage()})),
			this.movementMessage(Component.translatable("demo.help.inventory", new Object[]{options.keyInventory.getTranslatedKeyMessage()}))
		);
	...
	public void render(GuiGraphics guiGraphics, int i, int j, float f) {
		...
		this.durationMessage.visitLines(TextAlignment.LEFT, k, l + 20, 9, activeTextCollector);
	}
}
