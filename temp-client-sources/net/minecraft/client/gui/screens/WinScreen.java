...
public class WinScreen extends Screen {
	...
	private void wrapCreditsIO(Identifier identifier, WinScreen.CreditsReader creditsReader) {
		try {
			Reader reader = this.minecraft.getResourceManager().openAsReader(identifier);
