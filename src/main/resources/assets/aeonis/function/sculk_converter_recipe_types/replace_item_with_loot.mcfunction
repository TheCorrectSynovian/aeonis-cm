...
$loot replace entity @e[tag=deeper_dark.sculk_converter.recipes.item,limit=1,sort=nearest] container.0 loot $(with)
data modify entity @s data.newItem set from entity @e[tag=deeper_dark.sculk_converter.recipes.item,limit=1,sort=nearest] item
