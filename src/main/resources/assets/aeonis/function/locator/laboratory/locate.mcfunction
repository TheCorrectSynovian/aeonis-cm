execute positioned ~1 ~ ~ store result score Game deeper_dark.distx+1 run locate structure deeper_dark:laboratory
execute positioned ~-1 ~ ~ store result score Game deeper_dark.distx-1 run locate structure deeper_dark:laboratory
execute positioned ~ ~ ~1 store result score Game deeper_dark.distz+1 run locate structure deeper_dark:laboratory
execute positioned ~ ~ ~-1 store result score Game deeper_dark.distz-1 run locate structure deeper_dark:laboratory
...
execute as @s positioned as @s run function deeper_dark:locator/laboratory/locate